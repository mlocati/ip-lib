...
class ValidTest extends TestCase
{
    public function validAddressesProvider()
    {
        return array(
            ...
            array('127', '127.0.0.0', '127.0.0.0'),
            array('127.0', '127.0.0.0', '127.0.0.0'),
            array('127.0.0', '127.0.0.0', '127.0.0.0'),
            array('127.1', '127.0.0.1', '127.0.0.1'),
            array('127.0.1', '127.0.0.1', '127.0.0.1'),
